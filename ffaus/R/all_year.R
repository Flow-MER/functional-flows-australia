...
# =====================================================
# Updates log
#  - 24/8/22 - added in all threshold values
...
#' @param user_q10_thresh A user defined 10th percentile threshold value.
#'                        In the same units of flow as in flow_matrix.
#' @param user_q25_thresh A user defined 25th percentile threshold value.
#'                        In the same units of flow as in flow_matrix.
#' @param user_q50_thresh A user defined 50th percentile threshold value.
#'                        In the same units of flow as in flow_matrix.
                        ...
                        user_q90_thresh = NULL)
{
  ...
  if (!is.null(user_q10_thresh))
  {
    mags_global[1] <- user_q10_thresh
  }
  
  if (!is.null(user_q25_thresh))
  {
    mags_global[2] <- user_q25_thresh
  }
  
  if (!is.null(user_q50_thresh))
  {
    mags_global[3] <- user_q50_thresh
  }
